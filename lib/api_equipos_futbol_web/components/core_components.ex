defmodule ApiEquiposFutbolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ApiEquiposFutbolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ApiEquiposFutbolWeb.Gettext, "errors", msg, opts)
    end
  end
